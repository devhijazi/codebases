...
type DiaristCreateSchemaType = YupObjectSchemaType<
  Omit<DiaristCreateData, 'address'>
>;

type DiaristAddressCreateSchemaType = YupObjectSchemaType<
  LeanModel<DiaristAddress>
>;

export const diaristCreateSchema = object<DiaristCreateSchemaType>({
...
export const diaristAddressCreateSchema =
  object<DiaristAddressCreateSchemaType>({
